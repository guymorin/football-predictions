...
class Forms
{
    ...
    public function deleteForm($page, $name, $id, $confirm=false, $nameOther=null, $idOther=null){
        ...
        else $val .= $this->submit(Theme::icon('delete')." ".Language::title('delete'));
        $val .= "</form>\n";
        return $val;
    }
     ...
     */
    public function input($label='',$name,$id=null,$maxlength=50){
         $val = '';
         if($label!='') $val.= $this->label($label);
         $val.= "<input maxlength='".$maxlength."' type='text' name='$name' ";
