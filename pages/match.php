...
// Popup if needed
    ...
    elseif($create==1){
        ...
        // Create form 
            ...
            echo $form->inputHidden('matchdayId', $_SESSION['matchdayId']);

            echo $form->inputDate($title_date, 'date', '');
            ...
            echo "<table>\n";
            echo "  <tr>\n";
            echo "      <td>1" . $form->inputNumber('', 'odds1', '0', '0.01') . "</td>\n";
            echo "      <td>" . $title_draw . $form->inputNumber('', 'oddsD', '0', '0.01') . "</td>\n";
            echo "      <td>2" . $form->inputNumber('', 'odds2', '0', '0.01') . "</td>\n";
            echo "  </tr>\n";
            echo "</table>\n";

            echo $form->labelBr($title_result);
            echo "<table>\n";
            echo "  <tr>\n";
            echo "      <td>\n";
            echo $form->labelId('1', '1');
            echo $form->inputRadio('1', 'result', '1', false);
            echo "      </td>\n";
            echo "      <td>\n";
            echo $form->labelId('D', $title_draw);
            echo $form->inputRadio('D', 'result', 'D', false);
            echo "      </td>\n";
            echo "      <td>\n";
            echo $form->labelId('2', '2');
            echo $form->inputRadio('2', 'result', '2', false);
            echo "  </tr>\n";
            echo "</table>\n";
            echo "<br />" . $form->submit($title_create);
