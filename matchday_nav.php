...
if(isset($_SESSION['idJournee'])) {
    ...
    echo "  	<a href=\"index.php?page=matchday&sortie=1\">J".$_SESSION['numJournee']." &#10060;</a>\n"; // Sortir
    echo "  	<a href=\"index.php?page=matchday\">Statistiques</a>\n"; // Stats
...
} else echo "  	<a href=\"index.php?page=matchday&cree=1\">Créer une journée</a>\n"; // Créer
